...
export const incidenceAPI = {
  ...
  create: async (data) => {
    const response = await api.post("/incidences", data);
    return response.data;
  },
  getById: async (id) => {
  ...
  getByUser: async (userId) => {
    const response = await api.get(`/incidences/user/${userId}`);
    return response.data;
  },
...
export const appealAPI = {
  ...
  getByIncidence: async (incidenceId) => {
    const response = await api.get(`/appeals/incidence/${incidenceId}`);
    return response.data;
  },
  create: async (data) => {
